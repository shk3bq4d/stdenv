...
8.6.1,true,client,client.user.hash,keyword,extended,,,Unique user hash to correlate information for a user in anonymized form.
...
8.6.1,true,container,container.image.hash.all,keyword,extended,array,[sha256:f8fefc80e3273dc756f288a63945820d6476ad64883892c771b5e2ece6bf1b26],An array of digests of the image the container was built on.
...
8.6.1,true,destination,destination.user.full_name,keyword,extended,,Albert Einstein,"User's full name, if available."
...
8.6.1,true,dll,dll.pe.original_file_name,keyword,extended,,MSPAINT.EXE,"Internal name of the file, provided at compile-time."
...
8.6.1,true,email,email.origination_timestamp,date,extended,,2020-11-10T22:12:34.8196921Z,Date and time the email was composed.
...
8.6.1,true,faas,faas.coldstart,boolean,extended,,,Boolean value indicating a cold start of a function.
...
8.6.1,true,file,file.elf.sections.physical_offset,keyword,extended,,,ELF Section List offset.
...
8.6.1,true,file,file.x509.issuer.locality,keyword,extended,array,Mountain View,List of locality names (L)
...
8.6.1,true,host,host.id,keyword,core,,,Unique host id.
...
8.6.1,true,http,http.response.bytes,long,extended,,1437,Total size in bytes of the response (body and headers).
...
8.6.1,true,observer,observer.egress.vlan.name,keyword,extended,,outside,Optional VLAN name as reported by the observer.
...
8.6.1,true,orchestrator,orchestrator.organization,keyword,extended,,elastic,Organization affected by the event (for multi-tenant orchestrator setups).
...
8.6.1,true,process,process.elf.byte_order,keyword,extended,,Little Endian,Byte sequence of ELF file.
...
8.6.1,true,process,process.entry_leader.executable.text,match_only_text,extended,,/usr/bin/ssh,Absolute path to the process executable.
...
8.6.1,true,process,process.executable,keyword,extended,,/usr/bin/ssh,Absolute path to the process executable.
...
8.6.1,true,process,process.group_leader.user.name.text,match_only_text,core,,a.einstein,Short name or login of the user.
...
8.6.1,true,process,process.parent.elf.creation_date,date,extended,,,Build or compile date.
...
8.6.1,true,process,process.parent.hash.tlsh,keyword,extended,,,TLSH hash.
...
8.6.1,true,process,process.parent.working_directory,keyword,extended,,/home/alice,The working directory of the process.
...
8.6.1,true,process,process.session_leader.interactive,boolean,extended,,True,Whether the process is connected to an interactive shell.
...
8.6.1,true,process,process.title,keyword,extended,,,Process title.
...
8.6.1,true,server,server.geo.location,geo_point,core,,"{ ""lon"": -73.614830, ""lat"": 45.505918 }",Longitude and latitude.
...
8.6.1,true,server,server.user.full_name.text,match_only_text,extended,,Albert Einstein,"User's full name, if available."
8.6.1,true,server,server.user.group.domain,keyword,extended,,,Name of the directory the group is a member of.
8.6.1,true,server,server.user.group.id,keyword,extended,,,Unique identifier for the group on the system/platform.
8.6.1,true,server,server.user.group.name,keyword,extended,,,Name of the group.
8.6.1,true,server,server.user.hash,keyword,extended,,,Unique user hash to correlate information for a user in anonymized form.
8.6.1,true,server,server.user.id,keyword,core,,S-1-5-21-202424912787-2692429404-2351956786-1000,Unique identifier of the user.
8.6.1,true,server,server.user.name,keyword,core,,a.einstein,Short name or login of the user.
8.6.1,true,server,server.user.name.text,match_only_text,core,,a.einstein,Short name or login of the user.
8.6.1,true,server,server.user.roles,keyword,extended,array,"[""kibana_admin"", ""reporting_user""]",Array of user roles at the time of the event.
8.6.1,true,service,service.address,keyword,extended,,172.26.0.2:5432,Address of this service.
8.6.1,true,service,service.environment,keyword,extended,,production,Environment of the service.
8.6.1,true,service,service.ephemeral_id,keyword,extended,,8a4f500f,Ephemeral identifier of this service.
8.6.1,true,service,service.id,keyword,core,,d37e5ebfe0ae6c4972dbe9f0174a1637bb8247f6,Unique identifier of the running service.
8.6.1,true,service,service.name,keyword,core,,elasticsearch-metrics,Name of the service.
8.6.1,true,service,service.node.name,keyword,extended,,instance-0000000016,Name of the service node.
8.6.1,true,service,service.node.role,keyword,extended,,background_tasks,Deprecated role (singular) of the service node.
8.6.1,true,service,service.node.roles,keyword,extended,array,"[""ui"", ""background_tasks""]",Roles of the service node.
8.6.1,true,service,service.origin.address,keyword,extended,,172.26.0.2:5432,Address of this service.
8.6.1,true,service,service.origin.environment,keyword,extended,,production,Environment of the service.
8.6.1,true,service,service.origin.ephemeral_id,keyword,extended,,8a4f500f,Ephemeral identifier of this service.
8.6.1,true,service,service.origin.id,keyword,core,,d37e5ebfe0ae6c4972dbe9f0174a1637bb8247f6,Unique identifier of the running service.
8.6.1,true,service,service.origin.name,keyword,core,,elasticsearch-metrics,Name of the service.
8.6.1,true,service,service.origin.node.name,keyword,extended,,instance-0000000016,Name of the service node.
8.6.1,true,service,service.origin.node.role,keyword,extended,,background_tasks,Deprecated role (singular) of the service node.
8.6.1,true,service,service.origin.node.roles,keyword,extended,array,"[""ui"", ""background_tasks""]",Roles of the service node.
8.6.1,true,service,service.origin.state,keyword,core,,,Current state of the service.
8.6.1,true,service,service.origin.type,keyword,core,,elasticsearch,The type of the service.
8.6.1,true,service,service.origin.version,keyword,core,,3.2.4,Version of the service.
8.6.1,true,service,service.state,keyword,core,,,Current state of the service.
8.6.1,true,service,service.target.address,keyword,extended,,172.26.0.2:5432,Address of this service.
8.6.1,true,service,service.target.environment,keyword,extended,,production,Environment of the service.
8.6.1,true,service,service.target.ephemeral_id,keyword,extended,,8a4f500f,Ephemeral identifier of this service.
8.6.1,true,service,service.target.id,keyword,core,,d37e5ebfe0ae6c4972dbe9f0174a1637bb8247f6,Unique identifier of the running service.
8.6.1,true,service,service.target.name,keyword,core,,elasticsearch-metrics,Name of the service.
8.6.1,true,service,service.target.node.name,keyword,extended,,instance-0000000016,Name of the service node.
8.6.1,true,service,service.target.node.role,keyword,extended,,background_tasks,Deprecated role (singular) of the service node.
8.6.1,true,service,service.target.node.roles,keyword,extended,array,"[""ui"", ""background_tasks""]",Roles of the service node.
8.6.1,true,service,service.target.state,keyword,core,,,Current state of the service.
8.6.1,true,service,service.target.type,keyword,core,,elasticsearch,The type of the service.
8.6.1,true,service,service.target.version,keyword,core,,3.2.4,Version of the service.
8.6.1,true,service,service.type,keyword,core,,elasticsearch,The type of the service.
8.6.1,true,service,service.version,keyword,core,,3.2.4,Version of the service.
8.6.1,true,source,source.address,keyword,extended,,,Source network address.
8.6.1,true,source,source.as.number,long,extended,,15169,Unique number allocated to the autonomous system.
8.6.1,true,source,source.as.organization.name,keyword,extended,,Google LLC,Organization name.
8.6.1,true,source,source.as.organization.name.text,match_only_text,extended,,Google LLC,Organization name.
8.6.1,true,source,source.bytes,long,core,,184,Bytes sent from the source to the destination.
8.6.1,true,source,source.domain,keyword,core,,foo.example.com,The domain name of the source.
8.6.1,true,source,source.geo.city_name,keyword,core,,Montreal,City name.
8.6.1,true,source,source.geo.continent_code,keyword,core,,NA,Continent code.
8.6.1,true,source,source.geo.continent_name,keyword,core,,North America,Name of the continent.
8.6.1,true,source,source.geo.country_iso_code,keyword,core,,CA,Country ISO code.
8.6.1,true,source,source.geo.country_name,keyword,core,,Canada,Country name.
8.6.1,true,source,source.geo.location,geo_point,core,,"{ ""lon"": -73.614830, ""lat"": 45.505918 }",Longitude and latitude.
8.6.1,true,source,source.geo.name,keyword,extended,,boston-dc,User-defined description of a location.
8.6.1,true,source,source.geo.postal_code,keyword,core,,94040,Postal code.
8.6.1,true,source,source.geo.region_iso_code,keyword,core,,CA-QC,Region ISO code.
8.6.1,true,source,source.geo.region_name,keyword,core,,Quebec,Region name.
8.6.1,true,source,source.geo.timezone,keyword,core,,America/Argentina/Buenos_Aires,Time zone.
8.6.1,true,source,source.ip,ip,core,,,IP address of the source.
8.6.1,true,source,source.mac,keyword,core,,00-00-5E-00-53-23,MAC address of the source.
8.6.1,true,source,source.nat.ip,ip,extended,,,Source NAT ip
8.6.1,true,source,source.nat.port,long,extended,,,Source NAT port
8.6.1,true,source,source.packets,long,core,,12,Packets sent from the source to the destination.
8.6.1,true,source,source.port,long,core,,,Port of the source.
8.6.1,true,source,source.registered_domain,keyword,extended,,example.com,"The highest registered source domain, stripped of the subdomain."
8.6.1,true,source,source.subdomain,keyword,extended,,east,The subdomain of the domain.
8.6.1,true,source,source.top_level_domain,keyword,extended,,co.uk,"The effective top level domain (com, org, net, co.uk)."
8.6.1,true,source,source.user.domain,keyword,extended,,,Name of the directory the user is a member of.
8.6.1,true,source,source.user.email,keyword,extended,,,User email address.
8.6.1,true,source,source.user.full_name,keyword,extended,,Albert Einstein,"User's full name, if available."
8.6.1,true,source,source.user.full_name.text,match_only_text,extended,,Albert Einstein,"User's full name, if available."
8.6.1,true,source,source.user.group.domain,keyword,extended,,,Name of the directory the group is a member of.
8.6.1,true,source,source.user.group.id,keyword,extended,,,Unique identifier for the group on the system/platform.
8.6.1,true,source,source.user.group.name,keyword,extended,,,Name of the group.
8.6.1,true,source,source.user.hash,keyword,extended,,,Unique user hash to correlate information for a user in anonymized form.
8.6.1,true,source,source.user.id,keyword,core,,S-1-5-21-202424912787-2692429404-2351956786-1000,Unique identifier of the user.
8.6.1,true,source,source.user.name,keyword,core,,a.einstein,Short name or login of the user.
8.6.1,true,source,source.user.name.text,match_only_text,core,,a.einstein,Short name or login of the user.
8.6.1,true,source,source.user.roles,keyword,extended,array,"[""kibana_admin"", ""reporting_user""]",Array of user roles at the time of the event.
8.6.1,true,span,span.id,keyword,extended,,3ff9a8981b7ccd5a,Unique identifier of the span within the scope of its trace.
8.6.1,true,threat,threat.enrichments,nested,extended,array,,List of objects containing indicators enriching the event.
8.6.1,true,threat,threat.enrichments.indicator,object,extended,,,Object containing indicators enriching the event.
8.6.1,true,threat,threat.enrichments.indicator.as.number,long,extended,,15169,Unique number allocated to the autonomous system.
8.6.1,true,threat,threat.enrichments.indicator.as.organization.name,keyword,extended,,Google LLC,Organization name.
8.6.1,true,threat,threat.enrichments.indicator.as.organization.name.text,match_only_text,extended,,Google LLC,Organization name.
8.6.1,true,threat,threat.enrichments.indicator.confidence,keyword,extended,,Medium,Indicator confidence rating
8.6.1,true,threat,threat.enrichments.indicator.description,keyword,extended,,IP x.x.x.x was observed delivering the Angler EK.,Indicator description
8.6.1,true,threat,threat.enrichments.indicator.email.address,keyword,extended,,phish@example.com,Indicator email address
8.6.1,true,threat,threat.enrichments.indicator.file.accessed,date,extended,,,Last time the file was accessed.
8.6.1,true,threat,threat.enrichments.indicator.file.attributes,keyword,extended,array,"[""readonly"", ""system""]",Array of file attributes.
8.6.1,true,threat,threat.enrichments.indicator.file.code_signature.digest_algorithm,keyword,extended,,sha256,Hashing algorithm used to sign the process.
8.6.1,true,threat,threat.enrichments.indicator.file.code_signature.exists,boolean,core,,true,Boolean to capture if a signature is present.
8.6.1,true,threat,threat.enrichments.indicator.file.code_signature.signing_id,keyword,extended,,com.apple.xpc.proxy,The identifier used to sign the process.
8.6.1,true,threat,threat.enrichments.indicator.file.code_signature.status,keyword,extended,,ERROR_UNTRUSTED_ROOT,Additional information about the certificate status.
8.6.1,true,threat,threat.enrichments.indicator.file.code_signature.subject_name,keyword,core,,Microsoft Corporation,Subject name of the code signer
8.6.1,true,threat,threat.enrichments.indicator.file.code_signature.team_id,keyword,extended,,EQHXZ8M8AV,The team identifier used to sign the process.
8.6.1,true,threat,threat.enrichments.indicator.file.code_signature.timestamp,date,extended,,2021-01-01T12:10:30Z,When the signature was generated and signed.
8.6.1,true,threat,threat.enrichments.indicator.file.code_signature.trusted,boolean,extended,,true,Stores the trust status of the certificate chain.
8.6.1,true,threat,threat.enrichments.indicator.file.code_signature.valid,boolean,extended,,true,Boolean to capture if the digital signature is verified against the binary content.
8.6.1,true,threat,threat.enrichments.indicator.file.created,date,extended,,,File creation time.
8.6.1,true,threat,threat.enrichments.indicator.file.ctime,date,extended,,,Last time the file attributes or metadata changed.
8.6.1,true,threat,threat.enrichments.indicator.file.device,keyword,extended,,sda,Device that is the source of the file.
8.6.1,true,threat,threat.enrichments.indicator.file.directory,keyword,extended,,/home/alice,Directory where the file is located.
8.6.1,true,threat,threat.enrichments.indicator.file.drive_letter,keyword,extended,,C,Drive letter where the file is located.
8.6.1,true,threat,threat.enrichments.indicator.file.elf.architecture,keyword,extended,,x86-64,Machine architecture of the ELF file.
8.6.1,true,threat,threat.enrichments.indicator.file.elf.byte_order,keyword,extended,,Little Endian,Byte sequence of ELF file.
8.6.1,true,threat,threat.enrichments.indicator.file.elf.cpu_type,keyword,extended,,Intel,CPU type of the ELF file.
8.6.1,true,threat,threat.enrichments.indicator.file.elf.creation_date,date,extended,,,Build or compile date.
8.6.1,true,threat,threat.enrichments.indicator.file.elf.exports,flattened,extended,array,,List of exported element names and types.
8.6.1,true,threat,threat.enrichments.indicator.file.elf.header.abi_version,keyword,extended,,,Version of the ELF Application Binary Interface (ABI).
8.6.1,true,threat,threat.enrichments.indicator.file.elf.header.class,keyword,extended,,,Header class of the ELF file.
8.6.1,true,threat,threat.enrichments.indicator.file.elf.header.data,keyword,extended,,,Data table of the ELF header.
8.6.1,true,threat,threat.enrichments.indicator.file.elf.header.entrypoint,long,extended,,,Header entrypoint of the ELF file.
8.6.1,true,threat,threat.enrichments.indicator.file.elf.header.object_version,keyword,extended,,,"""0x1"" for original ELF files."
8.6.1,true,threat,threat.enrichments.indicator.file.elf.header.os_abi,keyword,extended,,,Application Binary Interface (ABI) of the Linux OS.
8.6.1,true,threat,threat.enrichments.indicator.file.elf.header.type,keyword,extended,,,Header type of the ELF file.
8.6.1,true,threat,threat.enrichments.indicator.file.elf.header.version,keyword,extended,,,Version of the ELF header.
8.6.1,true,threat,threat.enrichments.indicator.file.elf.imports,flattened,extended,array,,List of imported element names and types.
8.6.1,true,threat,threat.enrichments.indicator.file.elf.sections,nested,extended,array,,Section information of the ELF file.
8.6.1,true,threat,threat.enrichments.indicator.file.elf.sections.chi2,long,extended,,,Chi-square probability distribution of the section.
8.6.1,true,threat,threat.enrichments.indicator.file.elf.sections.entropy,long,extended,,,Shannon entropy calculation from the section.
8.6.1,true,threat,threat.enrichments.indicator.file.elf.sections.flags,keyword,extended,,,ELF Section List flags.
8.6.1,true,threat,threat.enrichments.indicator.file.elf.sections.name,keyword,extended,,,ELF Section List name.
8.6.1,true,threat,threat.enrichments.indicator.file.elf.sections.physical_offset,keyword,extended,,,ELF Section List offset.
8.6.1,true,threat,threat.enrichments.indicator.file.elf.sections.physical_size,long,extended,,,ELF Section List physical size.
8.6.1,true,threat,threat.enrichments.indicator.file.elf.sections.type,keyword,extended,,,ELF Section List type.
8.6.1,true,threat,threat.enrichments.indicator.file.elf.sections.virtual_address,long,extended,,,ELF Section List virtual address.
8.6.1,true,threat,threat.enrichments.indicator.file.elf.sections.virtual_size,long,extended,,,ELF Section List virtual size.
8.6.1,true,threat,threat.enrichments.indicator.file.elf.segments,nested,extended,array,,ELF object segment list.
8.6.1,true,threat,threat.enrichments.indicator.file.elf.segments.sections,keyword,extended,,,ELF object segment sections.
8.6.1,true,threat,threat.enrichments.indicator.file.elf.segments.type,keyword,extended,,,ELF object segment type.
8.6.1,true,threat,threat.enrichments.indicator.file.elf.shared_libraries,keyword,extended,array,,List of shared libraries used by this ELF object.
8.6.1,true,threat,threat.enrichments.indicator.file.elf.telfhash,keyword,extended,,,telfhash hash for ELF file.
8.6.1,true,threat,threat.enrichments.indicator.file.extension,keyword,extended,,png,"File extension, excluding the leading dot."
8.6.1,true,threat,threat.enrichments.indicator.file.fork_name,keyword,extended,,Zone.Identifer,A fork is additional data associated with a filesystem object.
8.6.1,true,threat,threat.enrichments.indicator.file.gid,keyword,extended,,1001,Primary group ID (GID) of the file.
8.6.1,true,threat,threat.enrichments.indicator.file.group,keyword,extended,,alice,Primary group name of the file.
8.6.1,true,threat,threat.enrichments.indicator.file.hash.md5,keyword,extended,,,MD5 hash.
8.6.1,true,threat,threat.enrichments.indicator.file.hash.sha1,keyword,extended,,,SHA1 hash.
8.6.1,true,threat,threat.enrichments.indicator.file.hash.sha256,keyword,extended,,,SHA256 hash.
8.6.1,true,threat,threat.enrichments.indicator.file.hash.sha384,keyword,extended,,,SHA384 hash.
8.6.1,true,threat,threat.enrichments.indicator.file.hash.sha512,keyword,extended,,,SHA512 hash.
8.6.1,true,threat,threat.enrichments.indicator.file.hash.ssdeep,keyword,extended,,,SSDEEP hash.
8.6.1,true,threat,threat.enrichments.indicator.file.hash.tlsh,keyword,extended,,,TLSH hash.
8.6.1,true,threat,threat.enrichments.indicator.file.inode,keyword,extended,,256383,Inode representing the file in the filesystem.
8.6.1,true,threat,threat.enrichments.indicator.file.mime_type,keyword,extended,,,"Media type of file, document, or arrangement of bytes."
8.6.1,true,threat,threat.enrichments.indicator.file.mode,keyword,extended,,0640,Mode of the file in octal representation.
8.6.1,true,threat,threat.enrichments.indicator.file.mtime,date,extended,,,Last time the file content was modified.
8.6.1,true,threat,threat.enrichments.indicator.file.name,keyword,extended,,example.png,"Name of the file including the extension, without the directory."
8.6.1,true,threat,threat.enrichments.indicator.file.owner,keyword,extended,,alice,File owner's username.
8.6.1,true,threat,threat.enrichments.indicator.file.path,keyword,extended,,/home/alice/example.png,"Full path to the file, including the file name."
8.6.1,true,threat,threat.enrichments.indicator.file.path.text,match_only_text,extended,,/home/alice/example.png,"Full path to the file, including the file name."
8.6.1,true,threat,threat.enrichments.indicator.file.pe.architecture,keyword,extended,,x64,CPU architecture target for the file.
8.6.1,true,threat,threat.enrichments.indicator.file.pe.company,keyword,extended,,Microsoft Corporation,"Internal company name of the file, provided at compile-time."
8.6.1,true,threat,threat.enrichments.indicator.file.pe.description,keyword,extended,,Paint,"Internal description of the file, provided at compile-time."
8.6.1,true,threat,threat.enrichments.indicator.file.pe.file_version,keyword,extended,,6.3.9600.17415,Process name.
8.6.1,true,threat,threat.enrichments.indicator.file.pe.imphash,keyword,extended,,0c6803c4e922103c4dca5963aad36ddf,A hash of the imports in a PE file.
8.6.1,true,threat,threat.enrichments.indicator.file.pe.original_file_name,keyword,extended,,MSPAINT.EXE,"Internal name of the file, provided at compile-time."
8.6.1,true,threat,threat.enrichments.indicator.file.pe.pehash,keyword,extended,,73ff189b63cd6be375a7ff25179a38d347651975,A hash of the PE header and data from one or more PE sections.
8.6.1,true,threat,threat.enrichments.indicator.file.pe.product,keyword,extended,,Microsoft® Windows® Operating System,"Internal product name of the file, provided at compile-time."
8.6.1,true,threat,threat.enrichments.indicator.file.size,long,extended,,16384,File size in bytes.
8.6.1,true,threat,threat.enrichments.indicator.file.target_path,keyword,extended,,,Target path for symlinks.
8.6.1,true,threat,threat.enrichments.indicator.file.target_path.text,match_only_text,extended,,,Target path for symlinks.
8.6.1,true,threat,threat.enrichments.indicator.file.type,keyword,extended,,file,"File type (file, dir, or symlink)."
8.6.1,true,threat,threat.enrichments.indicator.file.uid,keyword,extended,,1001,The user ID (UID) or security identifier (SID) of the file owner.
8.6.1,true,threat,threat.enrichments.indicator.file.x509.alternative_names,keyword,extended,array,*.elastic.co,List of subject alternative names (SAN).
8.6.1,true,threat,threat.enrichments.indicator.file.x509.issuer.common_name,keyword,extended,array,Example SHA2 High Assurance Server CA,List of common name (CN) of issuing certificate authority.
8.6.1,true,threat,threat.enrichments.indicator.file.x509.issuer.country,keyword,extended,array,US,List of country \(C) codes
8.6.1,true,threat,threat.enrichments.indicator.file.x509.issuer.distinguished_name,keyword,extended,,"C=US, O=Example Inc, OU=www.example.com, CN=Example SHA2 High Assurance Server CA",Distinguished name (DN) of issuing certificate authority.
8.6.1,true,threat,threat.enrichments.indicator.file.x509.issuer.locality,keyword,extended,array,Mountain View,List of locality names (L)
8.6.1,true,threat,threat.enrichments.indicator.file.x509.issuer.organization,keyword,extended,array,Example Inc,List of organizations (O) of issuing certificate authority.
8.6.1,true,threat,threat.enrichments.indicator.file.x509.issuer.organizational_unit,keyword,extended,array,www.example.com,List of organizational units (OU) of issuing certificate authority.
8.6.1,true,threat,threat.enrichments.indicator.file.x509.issuer.state_or_province,keyword,extended,array,California,"List of state or province names (ST, S, or P)"
8.6.1,true,threat,threat.enrichments.indicator.file.x509.not_after,date,extended,,2020-07-16T03:15:39Z,Time at which the certificate is no longer considered valid.
8.6.1,true,threat,threat.enrichments.indicator.file.x509.not_before,date,extended,,2019-08-16T01:40:25Z,Time at which the certificate is first considered valid.
8.6.1,true,threat,threat.enrichments.indicator.file.x509.public_key_algorithm,keyword,extended,,RSA,Algorithm used to generate the public key.
8.6.1,true,threat,threat.enrichments.indicator.file.x509.public_key_curve,keyword,extended,,nistp521,The curve used by the elliptic curve public key algorithm. This is algorithm specific.
8.6.1,false,threat,threat.enrichments.indicator.file.x509.public_key_exponent,long,extended,,65537,Exponent used to derive the public key. This is algorithm specific.
8.6.1,true,threat,threat.enrichments.indicator.file.x509.public_key_size,long,extended,,2048,The size of the public key space in bits.
8.6.1,true,threat,threat.enrichments.indicator.file.x509.serial_number,keyword,extended,,55FBB9C7DEBF09809D12CCAA,Unique serial number issued by the certificate authority.
8.6.1,true,threat,threat.enrichments.indicator.file.x509.signature_algorithm,keyword,extended,,SHA256-RSA,Identifier for certificate signature algorithm.
8.6.1,true,threat,threat.enrichments.indicator.file.x509.subject.common_name,keyword,extended,array,shared.global.example.net,List of common names (CN) of subject.
8.6.1,true,threat,threat.enrichments.indicator.file.x509.subject.country,keyword,extended,array,US,List of country \(C) code
8.6.1,true,threat,threat.enrichments.indicator.file.x509.subject.distinguished_name,keyword,extended,,"C=US, ST=California, L=San Francisco, O=Example, Inc., CN=shared.global.example.net",Distinguished name (DN) of the certificate subject entity.
8.6.1,true,threat,threat.enrichments.indicator.file.x509.subject.locality,keyword,extended,array,San Francisco,List of locality names (L)
8.6.1,true,threat,threat.enrichments.indicator.file.x509.subject.organization,keyword,extended,array,"Example, Inc.",List of organizations (O) of subject.
8.6.1,true,threat,threat.enrichments.indicator.file.x509.subject.organizational_unit,keyword,extended,array,,List of organizational units (OU) of subject.
8.6.1,true,threat,threat.enrichments.indicator.file.x509.subject.state_or_province,keyword,extended,array,California,"List of state or province names (ST, S, or P)"
8.6.1,true,threat,threat.enrichments.indicator.file.x509.version_number,keyword,extended,,3,Version of x509 format.
8.6.1,true,threat,threat.enrichments.indicator.first_seen,date,extended,,2020-11-05T17:25:47.000Z,Date/time indicator was first reported.
8.6.1,true,threat,threat.enrichments.indicator.geo.city_name,keyword,core,,Montreal,City name.
8.6.1,true,threat,threat.enrichments.indicator.geo.continent_code,keyword,core,,NA,Continent code.
8.6.1,true,threat,threat.enrichments.indicator.geo.continent_name,keyword,core,,North America,Name of the continent.
8.6.1,true,threat,threat.enrichments.indicator.geo.country_iso_code,keyword,core,,CA,Country ISO code.
8.6.1,true,threat,threat.enrichments.indicator.geo.country_name,keyword,core,,Canada,Country name.
8.6.1,true,threat,threat.enrichments.indicator.geo.location,geo_point,core,,"{ ""lon"": -73.614830, ""lat"": 45.505918 }",Longitude and latitude.
8.6.1,true,threat,threat.enrichments.indicator.geo.name,keyword,extended,,boston-dc,User-defined description of a location.
8.6.1,true,threat,threat.enrichments.indicator.geo.postal_code,keyword,core,,94040,Postal code.
8.6.1,true,threat,threat.enrichments.indicator.geo.region_iso_code,keyword,core,,CA-QC,Region ISO code.
8.6.1,true,threat,threat.enrichments.indicator.geo.region_name,keyword,core,,Quebec,Region name.
8.6.1,true,threat,threat.enrichments.indicator.geo.timezone,keyword,core,,America/Argentina/Buenos_Aires,Time zone.
8.6.1,true,threat,threat.enrichments.indicator.ip,ip,extended,,1.2.3.4,Indicator IP address
8.6.1,true,threat,threat.enrichments.indicator.last_seen,date,extended,,2020-11-05T17:25:47.000Z,Date/time indicator was last reported.
8.6.1,true,threat,threat.enrichments.indicator.marking.tlp,keyword,extended,,CLEAR,Indicator TLP marking
8.6.1,true,threat,threat.enrichments.indicator.marking.tlp_version,keyword,extended,,2.0,Indicator TLP version
8.6.1,true,threat,threat.enrichments.indicator.modified_at,date,extended,,2020-11-05T17:25:47.000Z,Date/time indicator was last updated.
8.6.1,true,threat,threat.enrichments.indicator.port,long,extended,,443,Indicator port
8.6.1,true,threat,threat.enrichments.indicator.provider,keyword,extended,,lrz_urlhaus,Indicator provider
8.6.1,true,threat,threat.enrichments.indicator.reference,keyword,extended,,https://system.example.com/indicator/0001234,Indicator reference URL
8.6.1,true,threat,threat.enrichments.indicator.registry.data.bytes,keyword,extended,,ZQBuAC0AVQBTAAAAZQBuAAAAAAA=,Original bytes written with base64 encoding.
8.6.1,true,threat,threat.enrichments.indicator.registry.data.strings,wildcard,core,array,"[""C:\rta\red_ttp\bin\myapp.exe""]",List of strings representing what was written to the registry.
8.6.1,true,threat,threat.enrichments.indicator.registry.data.type,keyword,core,,REG_SZ,Standard registry type for encoding contents
8.6.1,true,threat,threat.enrichments.indicator.registry.hive,keyword,core,,HKLM,Abbreviated name for the hive.
8.6.1,true,threat,threat.enrichments.indicator.registry.key,keyword,core,,SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\winword.exe,Hive-relative path of keys.
8.6.1,true,threat,threat.enrichments.indicator.registry.path,keyword,core,,HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\winword.exe\Debugger,"Full path, including hive, key and value"
8.6.1,true,threat,threat.enrichments.indicator.registry.value,keyword,core,,Debugger,Name of the value written.
8.6.1,true,threat,threat.enrichments.indicator.scanner_stats,long,extended,,4,Scanner statistics
8.6.1,true,threat,threat.enrichments.indicator.sightings,long,extended,,20,Number of times indicator observed
8.6.1,true,threat,threat.enrichments.indicator.type,keyword,extended,,ipv4-addr,Type of indicator
8.6.1,true,threat,threat.enrichments.indicator.url.domain,keyword,extended,,www.elastic.co,Domain of the url.
8.6.1,true,threat,threat.enrichments.indicator.url.extension,keyword,extended,,png,"File extension from the request url, excluding the leading dot."
8.6.1,true,threat,threat.enrichments.indicator.url.fragment,keyword,extended,,,Portion of the url after the `#`.
8.6.1,true,threat,threat.enrichments.indicator.url.full,wildcard,extended,,https://www.elastic.co:443/search?q=elasticsearch#top,Full unparsed URL.
8.6.1,true,threat,threat.enrichments.indicator.url.full.text,match_only_text,extended,,https://www.elastic.co:443/search?q=elasticsearch#top,Full unparsed URL.
8.6.1,true,threat,threat.enrichments.indicator.url.original,wildcard,extended,,https://www.elastic.co:443/search?q=elasticsearch#top or /search?q=elasticsearch,Unmodified original url as seen in the event source.
8.6.1,true,threat,threat.enrichments.indicator.url.original.text,match_only_text,extended,,https://www.elastic.co:443/search?q=elasticsearch#top or /search?q=elasticsearch,Unmodified original url as seen in the event source.
8.6.1,true,threat,threat.enrichments.indicator.url.password,keyword,extended,,,Password of the request.
8.6.1,true,threat,threat.enrichments.indicator.url.path,wildcard,extended,,,"Path of the request, such as ""/search""."
8.6.1,true,threat,threat.enrichments.indicator.url.port,long,extended,,443,"Port of the request, such as 443."
8.6.1,true,threat,threat.enrichments.indicator.url.query,keyword,extended,,,Query string of the request.
8.6.1,true,threat,threat.enrichments.indicator.url.registered_domain,keyword,extended,,example.com,"The highest registered url domain, stripped of the subdomain."
8.6.1,true,threat,threat.enrichments.indicator.url.scheme,keyword,extended,,https,Scheme of the url.
8.6.1,true,threat,threat.enrichments.indicator.url.subdomain,keyword,extended,,east,The subdomain of the domain.
8.6.1,true,threat,threat.enrichments.indicator.url.top_level_domain,keyword,extended,,co.uk,"The effective top level domain (com, org, net, co.uk)."
8.6.1,true,threat,threat.enrichments.indicator.url.username,keyword,extended,,,Username of the request.
8.6.1,true,threat,threat.enrichments.indicator.x509.alternative_names,keyword,extended,array,*.elastic.co,List of subject alternative names (SAN).
8.6.1,true,threat,threat.enrichments.indicator.x509.issuer.common_name,keyword,extended,array,Example SHA2 High Assurance Server CA,List of common name (CN) of issuing certificate authority.
8.6.1,true,threat,threat.enrichments.indicator.x509.issuer.country,keyword,extended,array,US,List of country \(C) codes
8.6.1,true,threat,threat.enrichments.indicator.x509.issuer.distinguished_name,keyword,extended,,"C=US, O=Example Inc, OU=www.example.com, CN=Example SHA2 High Assurance Server CA",Distinguished name (DN) of issuing certificate authority.
8.6.1,true,threat,threat.enrichments.indicator.x509.issuer.locality,keyword,extended,array,Mountain View,List of locality names (L)
8.6.1,true,threat,threat.enrichments.indicator.x509.issuer.organization,keyword,extended,array,Example Inc,List of organizations (O) of issuing certificate authority.
8.6.1,true,threat,threat.enrichments.indicator.x509.issuer.organizational_unit,keyword,extended,array,www.example.com,List of organizational units (OU) of issuing certificate authority.
8.6.1,true,threat,threat.enrichments.indicator.x509.issuer.state_or_province,keyword,extended,array,California,"List of state or province names (ST, S, or P)"
8.6.1,true,threat,threat.enrichments.indicator.x509.not_after,date,extended,,2020-07-16T03:15:39Z,Time at which the certificate is no longer considered valid.
8.6.1,true,threat,threat.enrichments.indicator.x509.not_before,date,extended,,2019-08-16T01:40:25Z,Time at which the certificate is first considered valid.
8.6.1,true,threat,threat.enrichments.indicator.x509.public_key_algorithm,keyword,extended,,RSA,Algorithm used to generate the public key.
8.6.1,true,threat,threat.enrichments.indicator.x509.public_key_curve,keyword,extended,,nistp521,The curve used by the elliptic curve public key algorithm. This is algorithm specific.
8.6.1,false,threat,threat.enrichments.indicator.x509.public_key_exponent,long,extended,,65537,Exponent used to derive the public key. This is algorithm specific.
8.6.1,true,threat,threat.enrichments.indicator.x509.public_key_size,long,extended,,2048,The size of the public key space in bits.
8.6.1,true,threat,threat.enrichments.indicator.x509.serial_number,keyword,extended,,55FBB9C7DEBF09809D12CCAA,Unique serial number issued by the certificate authority.
8.6.1,true,threat,threat.enrichments.indicator.x509.signature_algorithm,keyword,extended,,SHA256-RSA,Identifier for certificate signature algorithm.
8.6.1,true,threat,threat.enrichments.indicator.x509.subject.common_name,keyword,extended,array,shared.global.example.net,List of common names (CN) of subject.
8.6.1,true,threat,threat.enrichments.indicator.x509.subject.country,keyword,extended,array,US,List of country \(C) code
8.6.1,true,threat,threat.enrichments.indicator.x509.subject.distinguished_name,keyword,extended,,"C=US, ST=California, L=San Francisco, O=Example, Inc., CN=shared.global.example.net",Distinguished name (DN) of the certificate subject entity.
8.6.1,true,threat,threat.enrichments.indicator.x509.subject.locality,keyword,extended,array,San Francisco,List of locality names (L)
8.6.1,true,threat,threat.enrichments.indicator.x509.subject.organization,keyword,extended,array,"Example, Inc.",List of organizations (O) of subject.
8.6.1,true,threat,threat.enrichments.indicator.x509.subject.organizational_unit,keyword,extended,array,,List of organizational units (OU) of subject.
8.6.1,true,threat,threat.enrichments.indicator.x509.subject.state_or_province,keyword,extended,array,California,"List of state or province names (ST, S, or P)"
8.6.1,true,threat,threat.enrichments.indicator.x509.version_number,keyword,extended,,3,Version of x509 format.
8.6.1,true,threat,threat.enrichments.matched.atomic,keyword,extended,,bad-domain.com,Matched indicator value
8.6.1,true,threat,threat.enrichments.matched.field,keyword,extended,,file.hash.sha256,Matched indicator field
8.6.1,true,threat,threat.enrichments.matched.id,keyword,extended,,ff93aee5-86a1-4a61-b0e6-0cdc313d01b5,Matched indicator identifier
8.6.1,true,threat,threat.enrichments.matched.index,keyword,extended,,filebeat-8.0.0-2021.05.23-000011,Matched indicator index
8.6.1,true,threat,threat.enrichments.matched.occurred,date,extended,,2021-10-05T17:00:58.326Z,Date of match
8.6.1,true,threat,threat.enrichments.matched.type,keyword,extended,,indicator_match_rule,Type of indicator match
8.6.1,true,threat,threat.feed.dashboard_id,keyword,extended,,5ba16340-72e6-11eb-a3e3-b3cc7c78a70f,Feed dashboard ID.
8.6.1,true,threat,threat.feed.description,keyword,extended,,Threat feed from the AlienVault Open Threat eXchange network.,Description of the threat feed.
8.6.1,true,threat,threat.feed.name,keyword,extended,,AlienVault OTX,Name of the threat feed.
8.6.1,true,threat,threat.feed.reference,keyword,extended,,https://otx.alienvault.com,Reference for the threat feed.
8.6.1,true,threat,threat.framework,keyword,extended,,MITRE ATT&CK,Threat classification framework.
8.6.1,true,threat,threat.group.alias,keyword,extended,array,"[ ""Magecart Group 6"" ]",Alias of the group.
8.6.1,true,threat,threat.group.id,keyword,extended,,G0037,ID of the group.
8.6.1,true,threat,threat.group.name,keyword,extended,,FIN6,Name of the group.
8.6.1,true,threat,threat.group.reference,keyword,extended,,https://attack.mitre.org/groups/G0037/,Reference URL of the group.
8.6.1,true,threat,threat.indicator.as.number,long,extended,,15169,Unique number allocated to the autonomous system.
8.6.1,true,threat,threat.indicator.as.organization.name,keyword,extended,,Google LLC,Organization name.
8.6.1,true,threat,threat.indicator.as.organization.name.text,match_only_text,extended,,Google LLC,Organization name.
8.6.1,true,threat,threat.indicator.confidence,keyword,extended,,Medium,Indicator confidence rating
8.6.1,true,threat,threat.indicator.description,keyword,extended,,IP x.x.x.x was observed delivering the Angler EK.,Indicator description
8.6.1,true,threat,threat.indicator.email.address,keyword,extended,,phish@example.com,Indicator email address
8.6.1,true,threat,threat.indicator.file.accessed,date,extended,,,Last time the file was accessed.
8.6.1,true,threat,threat.indicator.file.attributes,keyword,extended,array,"[""readonly"", ""system""]",Array of file attributes.
8.6.1,true,threat,threat.indicator.file.code_signature.digest_algorithm,keyword,extended,,sha256,Hashing algorithm used to sign the process.
8.6.1,true,threat,threat.indicator.file.code_signature.exists,boolean,core,,true,Boolean to capture if a signature is present.
8.6.1,true,threat,threat.indicator.file.code_signature.signing_id,keyword,extended,,com.apple.xpc.proxy,The identifier used to sign the process.
8.6.1,true,threat,threat.indicator.file.code_signature.status,keyword,extended,,ERROR_UNTRUSTED_ROOT,Additional information about the certificate status.
8.6.1,true,threat,threat.indicator.file.code_signature.subject_name,keyword,core,,Microsoft Corporation,Subject name of the code signer
8.6.1,true,threat,threat.indicator.file.code_signature.team_id,keyword,extended,,EQHXZ8M8AV,The team identifier used to sign the process.
8.6.1,true,threat,threat.indicator.file.code_signature.timestamp,date,extended,,2021-01-01T12:10:30Z,When the signature was generated and signed.
8.6.1,true,threat,threat.indicator.file.code_signature.trusted,boolean,extended,,true,Stores the trust status of the certificate chain.
8.6.1,true,threat,threat.indicator.file.code_signature.valid,boolean,extended,,true,Boolean to capture if the digital signature is verified against the binary content.
8.6.1,true,threat,threat.indicator.file.created,date,extended,,,File creation time.
8.6.1,true,threat,threat.indicator.file.ctime,date,extended,,,Last time the file attributes or metadata changed.
8.6.1,true,threat,threat.indicator.file.device,keyword,extended,,sda,Device that is the source of the file.
8.6.1,true,threat,threat.indicator.file.directory,keyword,extended,,/home/alice,Directory where the file is located.
8.6.1,true,threat,threat.indicator.file.drive_letter,keyword,extended,,C,Drive letter where the file is located.
8.6.1,true,threat,threat.indicator.file.elf.architecture,keyword,extended,,x86-64,Machine architecture of the ELF file.
8.6.1,true,threat,threat.indicator.file.elf.byte_order,keyword,extended,,Little Endian,Byte sequence of ELF file.
8.6.1,true,threat,threat.indicator.file.elf.cpu_type,keyword,extended,,Intel,CPU type of the ELF file.
8.6.1,true,threat,threat.indicator.file.elf.creation_date,date,extended,,,Build or compile date.
8.6.1,true,threat,threat.indicator.file.elf.exports,flattened,extended,array,,List of exported element names and types.
8.6.1,true,threat,threat.indicator.file.elf.header.abi_version,keyword,extended,,,Version of the ELF Application Binary Interface (ABI).
8.6.1,true,threat,threat.indicator.file.elf.header.class,keyword,extended,,,Header class of the ELF file.
8.6.1,true,threat,threat.indicator.file.elf.header.data,keyword,extended,,,Data table of the ELF header.
8.6.1,true,threat,threat.indicator.file.elf.header.entrypoint,long,extended,,,Header entrypoint of the ELF file.
8.6.1,true,threat,threat.indicator.file.elf.header.object_version,keyword,extended,,,"""0x1"" for original ELF files."
8.6.1,true,threat,threat.indicator.file.elf.header.os_abi,keyword,extended,,,Application Binary Interface (ABI) of the Linux OS.
8.6.1,true,threat,threat.indicator.file.elf.header.type,keyword,extended,,,Header type of the ELF file.
8.6.1,true,threat,threat.indicator.file.elf.header.version,keyword,extended,,,Version of the ELF header.
8.6.1,true,threat,threat.indicator.file.elf.imports,flattened,extended,array,,List of imported element names and types.
8.6.1,true,threat,threat.indicator.file.elf.sections,nested,extended,array,,Section information of the ELF file.
8.6.1,true,threat,threat.indicator.file.elf.sections.chi2,long,extended,,,Chi-square probability distribution of the section.
8.6.1,true,threat,threat.indicator.file.elf.sections.entropy,long,extended,,,Shannon entropy calculation from the section.
8.6.1,true,threat,threat.indicator.file.elf.sections.flags,keyword,extended,,,ELF Section List flags.
8.6.1,true,threat,threat.indicator.file.elf.sections.name,keyword,extended,,,ELF Section List name.
8.6.1,true,threat,threat.indicator.file.elf.sections.physical_offset,keyword,extended,,,ELF Section List offset.
8.6.1,true,threat,threat.indicator.file.elf.sections.physical_size,long,extended,,,ELF Section List physical size.
8.6.1,true,threat,threat.indicator.file.elf.sections.type,keyword,extended,,,ELF Section List type.
8.6.1,true,threat,threat.indicator.file.elf.sections.virtual_address,long,extended,,,ELF Section List virtual address.
8.6.1,true,threat,threat.indicator.file.elf.sections.virtual_size,long,extended,,,ELF Section List virtual size.
8.6.1,true,threat,threat.indicator.file.elf.segments,nested,extended,array,,ELF object segment list.
8.6.1,true,threat,threat.indicator.file.elf.segments.sections,keyword,extended,,,ELF object segment sections.
8.6.1,true,threat,threat.indicator.file.elf.segments.type,keyword,extended,,,ELF object segment type.
8.6.1,true,threat,threat.indicator.file.elf.shared_libraries,keyword,extended,array,,List of shared libraries used by this ELF object.
8.6.1,true,threat,threat.indicator.file.elf.telfhash,keyword,extended,,,telfhash hash for ELF file.
8.6.1,true,threat,threat.indicator.file.extension,keyword,extended,,png,"File extension, excluding the leading dot."
8.6.1,true,threat,threat.indicator.file.fork_name,keyword,extended,,Zone.Identifer,A fork is additional data associated with a filesystem object.
8.6.1,true,threat,threat.indicator.file.gid,keyword,extended,,1001,Primary group ID (GID) of the file.
8.6.1,true,threat,threat.indicator.file.group,keyword,extended,,alice,Primary group name of the file.
8.6.1,true,threat,threat.indicator.file.hash.md5,keyword,extended,,,MD5 hash.
8.6.1,true,threat,threat.indicator.file.hash.sha1,keyword,extended,,,SHA1 hash.
8.6.1,true,threat,threat.indicator.file.hash.sha256,keyword,extended,,,SHA256 hash.
8.6.1,true,threat,threat.indicator.file.hash.sha384,keyword,extended,,,SHA384 hash.
8.6.1,true,threat,threat.indicator.file.hash.sha512,keyword,extended,,,SHA512 hash.
8.6.1,true,threat,threat.indicator.file.hash.ssdeep,keyword,extended,,,SSDEEP hash.
8.6.1,true,threat,threat.indicator.file.hash.tlsh,keyword,extended,,,TLSH hash.
8.6.1,true,threat,threat.indicator.file.inode,keyword,extended,,256383,Inode representing the file in the filesystem.
8.6.1,true,threat,threat.indicator.file.mime_type,keyword,extended,,,"Media type of file, document, or arrangement of bytes."
8.6.1,true,threat,threat.indicator.file.mode,keyword,extended,,0640,Mode of the file in octal representation.
8.6.1,true,threat,threat.indicator.file.mtime,date,extended,,,Last time the file content was modified.
8.6.1,true,threat,threat.indicator.file.name,keyword,extended,,example.png,"Name of the file including the extension, without the directory."
8.6.1,true,threat,threat.indicator.file.owner,keyword,extended,,alice,File owner's username.
8.6.1,true,threat,threat.indicator.file.path,keyword,extended,,/home/alice/example.png,"Full path to the file, including the file name."
8.6.1,true,threat,threat.indicator.file.path.text,match_only_text,extended,,/home/alice/example.png,"Full path to the file, including the file name."
8.6.1,true,threat,threat.indicator.file.pe.architecture,keyword,extended,,x64,CPU architecture target for the file.
8.6.1,true,threat,threat.indicator.file.pe.company,keyword,extended,,Microsoft Corporation,"Internal company name of the file, provided at compile-time."
8.6.1,true,threat,threat.indicator.file.pe.description,keyword,extended,,Paint,"Internal description of the file, provided at compile-time."
8.6.1,true,threat,threat.indicator.file.pe.file_version,keyword,extended,,6.3.9600.17415,Process name.
8.6.1,true,threat,threat.indicator.file.pe.imphash,keyword,extended,,0c6803c4e922103c4dca5963aad36ddf,A hash of the imports in a PE file.
8.6.1,true,threat,threat.indicator.file.pe.original_file_name,keyword,extended,,MSPAINT.EXE,"Internal name of the file, provided at compile-time."
8.6.1,true,threat,threat.indicator.file.pe.pehash,keyword,extended,,73ff189b63cd6be375a7ff25179a38d347651975,A hash of the PE header and data from one or more PE sections.
8.6.1,true,threat,threat.indicator.file.pe.product,keyword,extended,,Microsoft® Windows® Operating System,"Internal product name of the file, provided at compile-time."
8.6.1,true,threat,threat.indicator.file.size,long,extended,,16384,File size in bytes.
8.6.1,true,threat,threat.indicator.file.target_path,keyword,extended,,,Target path for symlinks.
8.6.1,true,threat,threat.indicator.file.target_path.text,match_only_text,extended,,,Target path for symlinks.
8.6.1,true,threat,threat.indicator.file.type,keyword,extended,,file,"File type (file, dir, or symlink)."
8.6.1,true,threat,threat.indicator.file.uid,keyword,extended,,1001,The user ID (UID) or security identifier (SID) of the file owner.
8.6.1,true,threat,threat.indicator.file.x509.alternative_names,keyword,extended,array,*.elastic.co,List of subject alternative names (SAN).
8.6.1,true,threat,threat.indicator.file.x509.issuer.common_name,keyword,extended,array,Example SHA2 High Assurance Server CA,List of common name (CN) of issuing certificate authority.
8.6.1,true,threat,threat.indicator.file.x509.issuer.country,keyword,extended,array,US,List of country \(C) codes
8.6.1,true,threat,threat.indicator.file.x509.issuer.distinguished_name,keyword,extended,,"C=US, O=Example Inc, OU=www.example.com, CN=Example SHA2 High Assurance Server CA",Distinguished name (DN) of issuing certificate authority.
8.6.1,true,threat,threat.indicator.file.x509.issuer.locality,keyword,extended,array,Mountain View,List of locality names (L)
8.6.1,true,threat,threat.indicator.file.x509.issuer.organization,keyword,extended,array,Example Inc,List of organizations (O) of issuing certificate authority.
8.6.1,true,threat,threat.indicator.file.x509.issuer.organizational_unit,keyword,extended,array,www.example.com,List of organizational units (OU) of issuing certificate authority.
8.6.1,true,threat,threat.indicator.file.x509.issuer.state_or_province,keyword,extended,array,California,"List of state or province names (ST, S, or P)"
8.6.1,true,threat,threat.indicator.file.x509.not_after,date,extended,,2020-07-16T03:15:39Z,Time at which the certificate is no longer considered valid.
8.6.1,true,threat,threat.indicator.file.x509.not_before,date,extended,,2019-08-16T01:40:25Z,Time at which the certificate is first considered valid.
8.6.1,true,threat,threat.indicator.file.x509.public_key_algorithm,keyword,extended,,RSA,Algorithm used to generate the public key.
8.6.1,true,threat,threat.indicator.file.x509.public_key_curve,keyword,extended,,nistp521,The curve used by the elliptic curve public key algorithm. This is algorithm specific.
8.6.1,false,threat,threat.indicator.file.x509.public_key_exponent,long,extended,,65537,Exponent used to derive the public key. This is algorithm specific.
8.6.1,true,threat,threat.indicator.file.x509.public_key_size,long,extended,,2048,The size of the public key space in bits.
8.6.1,true,threat,threat.indicator.file.x509.serial_number,keyword,extended,,55FBB9C7DEBF09809D12CCAA,Unique serial number issued by the certificate authority.
8.6.1,true,threat,threat.indicator.file.x509.signature_algorithm,keyword,extended,,SHA256-RSA,Identifier for certificate signature algorithm.
8.6.1,true,threat,threat.indicator.file.x509.subject.common_name,keyword,extended,array,shared.global.example.net,List of common names (CN) of subject.
8.6.1,true,threat,threat.indicator.file.x509.subject.country,keyword,extended,array,US,List of country \(C) code
8.6.1,true,threat,threat.indicator.file.x509.subject.distinguished_name,keyword,extended,,"C=US, ST=California, L=San Francisco, O=Example, Inc., CN=shared.global.example.net",Distinguished name (DN) of the certificate subject entity.
8.6.1,true,threat,threat.indicator.file.x509.subject.locality,keyword,extended,array,San Francisco,List of locality names (L)
8.6.1,true,threat,threat.indicator.file.x509.subject.organization,keyword,extended,array,"Example, Inc.",List of organizations (O) of subject.
8.6.1,true,threat,threat.indicator.file.x509.subject.organizational_unit,keyword,extended,array,,List of organizational units (OU) of subject.
8.6.1,true,threat,threat.indicator.file.x509.subject.state_or_province,keyword,extended,array,California,"List of state or province names (ST, S, or P)"
8.6.1,true,threat,threat.indicator.file.x509.version_number,keyword,extended,,3,Version of x509 format.
8.6.1,true,threat,threat.indicator.first_seen,date,extended,,2020-11-05T17:25:47.000Z,Date/time indicator was first reported.
8.6.1,true,threat,threat.indicator.geo.city_name,keyword,core,,Montreal,City name.
8.6.1,true,threat,threat.indicator.geo.continent_code,keyword,core,,NA,Continent code.
8.6.1,true,threat,threat.indicator.geo.continent_name,keyword,core,,North America,Name of the continent.
8.6.1,true,threat,threat.indicator.geo.country_iso_code,keyword,core,,CA,Country ISO code.
8.6.1,true,threat,threat.indicator.geo.country_name,keyword,core,,Canada,Country name.
8.6.1,true,threat,threat.indicator.geo.location,geo_point,core,,"{ ""lon"": -73.614830, ""lat"": 45.505918 }",Longitude and latitude.
8.6.1,true,threat,threat.indicator.geo.name,keyword,extended,,boston-dc,User-defined description of a location.
8.6.1,true,threat,threat.indicator.geo.postal_code,keyword,core,,94040,Postal code.
8.6.1,true,threat,threat.indicator.geo.region_iso_code,keyword,core,,CA-QC,Region ISO code.
8.6.1,true,threat,threat.indicator.geo.region_name,keyword,core,,Quebec,Region name.
8.6.1,true,threat,threat.indicator.geo.timezone,keyword,core,,America/Argentina/Buenos_Aires,Time zone.
8.6.1,true,threat,threat.indicator.ip,ip,extended,,1.2.3.4,Indicator IP address
8.6.1,true,threat,threat.indicator.last_seen,date,extended,,2020-11-05T17:25:47.000Z,Date/time indicator was last reported.
8.6.1,true,threat,threat.indicator.marking.tlp,keyword,extended,,CLEAR,Indicator TLP marking
8.6.1,true,threat,threat.indicator.marking.tlp_version,keyword,extended,,2.0,Indicator TLP version
8.6.1,true,threat,threat.indicator.modified_at,date,extended,,2020-11-05T17:25:47.000Z,Date/time indicator was last updated.
8.6.1,true,threat,threat.indicator.port,long,extended,,443,Indicator port
8.6.1,true,threat,threat.indicator.provider,keyword,extended,,lrz_urlhaus,Indicator provider
8.6.1,true,threat,threat.indicator.reference,keyword,extended,,https://system.example.com/indicator/0001234,Indicator reference URL
8.6.1,true,threat,threat.indicator.registry.data.bytes,keyword,extended,,ZQBuAC0AVQBTAAAAZQBuAAAAAAA=,Original bytes written with base64 encoding.
8.6.1,true,threat,threat.indicator.registry.data.strings,wildcard,core,array,"[""C:\rta\red_ttp\bin\myapp.exe""]",List of strings representing what was written to the registry.
8.6.1,true,threat,threat.indicator.registry.data.type,keyword,core,,REG_SZ,Standard registry type for encoding contents
8.6.1,true,threat,threat.indicator.registry.hive,keyword,core,,HKLM,Abbreviated name for the hive.
8.6.1,true,threat,threat.indicator.registry.key,keyword,core,,SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\winword.exe,Hive-relative path of keys.
8.6.1,true,threat,threat.indicator.registry.path,keyword,core,,HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\winword.exe\Debugger,"Full path, including hive, key and value"
8.6.1,true,threat,threat.indicator.registry.value,keyword,core,,Debugger,Name of the value written.
8.6.1,true,threat,threat.indicator.scanner_stats,long,extended,,4,Scanner statistics
8.6.1,true,threat,threat.indicator.sightings,long,extended,,20,Number of times indicator observed
8.6.1,true,threat,threat.indicator.type,keyword,extended,,ipv4-addr,Type of indicator
8.6.1,true,threat,threat.indicator.url.domain,keyword,extended,,www.elastic.co,Domain of the url.
8.6.1,true,threat,threat.indicator.url.extension,keyword,extended,,png,"File extension from the request url, excluding the leading dot."
8.6.1,true,threat,threat.indicator.url.fragment,keyword,extended,,,Portion of the url after the `#`.
8.6.1,true,threat,threat.indicator.url.full,wildcard,extended,,https://www.elastic.co:443/search?q=elasticsearch#top,Full unparsed URL.
8.6.1,true,threat,threat.indicator.url.full.text,match_only_text,extended,,https://www.elastic.co:443/search?q=elasticsearch#top,Full unparsed URL.
8.6.1,true,threat,threat.indicator.url.original,wildcard,extended,,https://www.elastic.co:443/search?q=elasticsearch#top or /search?q=elasticsearch,Unmodified original url as seen in the event source.
8.6.1,true,threat,threat.indicator.url.original.text,match_only_text,extended,,https://www.elastic.co:443/search?q=elasticsearch#top or /search?q=elasticsearch,Unmodified original url as seen in the event source.
8.6.1,true,threat,threat.indicator.url.password,keyword,extended,,,Password of the request.
8.6.1,true,threat,threat.indicator.url.path,wildcard,extended,,,"Path of the request, such as ""/search""."
8.6.1,true,threat,threat.indicator.url.port,long,extended,,443,"Port of the request, such as 443."
8.6.1,true,threat,threat.indicator.url.query,keyword,extended,,,Query string of the request.
8.6.1,true,threat,threat.indicator.url.registered_domain,keyword,extended,,example.com,"The highest registered url domain, stripped of the subdomain."
8.6.1,true,threat,threat.indicator.url.scheme,keyword,extended,,https,Scheme of the url.
8.6.1,true,threat,threat.indicator.url.subdomain,keyword,extended,,east,The subdomain of the domain.
8.6.1,true,threat,threat.indicator.url.top_level_domain,keyword,extended,,co.uk,"The effective top level domain (com, org, net, co.uk)."
8.6.1,true,threat,threat.indicator.url.username,keyword,extended,,,Username of the request.
8.6.1,true,threat,threat.indicator.x509.alternative_names,keyword,extended,array,*.elastic.co,List of subject alternative names (SAN).
8.6.1,true,threat,threat.indicator.x509.issuer.common_name,keyword,extended,array,Example SHA2 High Assurance Server CA,List of common name (CN) of issuing certificate authority.
8.6.1,true,threat,threat.indicator.x509.issuer.country,keyword,extended,array,US,List of country \(C) codes
8.6.1,true,threat,threat.indicator.x509.issuer.distinguished_name,keyword,extended,,"C=US, O=Example Inc, OU=www.example.com, CN=Example SHA2 High Assurance Server CA",Distinguished name (DN) of issuing certificate authority.
8.6.1,true,threat,threat.indicator.x509.issuer.locality,keyword,extended,array,Mountain View,List of locality names (L)
8.6.1,true,threat,threat.indicator.x509.issuer.organization,keyword,extended,array,Example Inc,List of organizations (O) of issuing certificate authority.
8.6.1,true,threat,threat.indicator.x509.issuer.organizational_unit,keyword,extended,array,www.example.com,List of organizational units (OU) of issuing certificate authority.
8.6.1,true,threat,threat.indicator.x509.issuer.state_or_province,keyword,extended,array,California,"List of state or province names (ST, S, or P)"
8.6.1,true,threat,threat.indicator.x509.not_after,date,extended,,2020-07-16T03:15:39Z,Time at which the certificate is no longer considered valid.
8.6.1,true,threat,threat.indicator.x509.not_before,date,extended,,2019-08-16T01:40:25Z,Time at which the certificate is first considered valid.
8.6.1,true,threat,threat.indicator.x509.public_key_algorithm,keyword,extended,,RSA,Algorithm used to generate the public key.
8.6.1,true,threat,threat.indicator.x509.public_key_curve,keyword,extended,,nistp521,The curve used by the elliptic curve public key algorithm. This is algorithm specific.
8.6.1,false,threat,threat.indicator.x509.public_key_exponent,long,extended,,65537,Exponent used to derive the public key. This is algorithm specific.
8.6.1,true,threat,threat.indicator.x509.public_key_size,long,extended,,2048,The size of the public key space in bits.
8.6.1,true,threat,threat.indicator.x509.serial_number,keyword,extended,,55FBB9C7DEBF09809D12CCAA,Unique serial number issued by the certificate authority.
8.6.1,true,threat,threat.indicator.x509.signature_algorithm,keyword,extended,,SHA256-RSA,Identifier for certificate signature algorithm.
8.6.1,true,threat,threat.indicator.x509.subject.common_name,keyword,extended,array,shared.global.example.net,List of common names (CN) of subject.
8.6.1,true,threat,threat.indicator.x509.subject.country,keyword,extended,array,US,List of country \(C) code
8.6.1,true,threat,threat.indicator.x509.subject.distinguished_name,keyword,extended,,"C=US, ST=California, L=San Francisco, O=Example, Inc., CN=shared.global.example.net",Distinguished name (DN) of the certificate subject entity.
8.6.1,true,threat,threat.indicator.x509.subject.locality,keyword,extended,array,San Francisco,List of locality names (L)
8.6.1,true,threat,threat.indicator.x509.subject.organization,keyword,extended,array,"Example, Inc.",List of organizations (O) of subject.
8.6.1,true,threat,threat.indicator.x509.subject.organizational_unit,keyword,extended,array,,List of organizational units (OU) of subject.
8.6.1,true,threat,threat.indicator.x509.subject.state_or_province,keyword,extended,array,California,"List of state or province names (ST, S, or P)"
8.6.1,true,threat,threat.indicator.x509.version_number,keyword,extended,,3,Version of x509 format.
8.6.1,true,threat,threat.software.alias,keyword,extended,array,"[ ""X-Agent"" ]",Alias of the software
8.6.1,true,threat,threat.software.id,keyword,extended,,S0552,ID of the software
8.6.1,true,threat,threat.software.name,keyword,extended,,AdFind,Name of the software.
8.6.1,true,threat,threat.software.platforms,keyword,extended,array,"[ ""Windows"" ]",Platforms of the software.
8.6.1,true,threat,threat.software.reference,keyword,extended,,https://attack.mitre.org/software/S0552/,Software reference URL.
8.6.1,true,threat,threat.software.type,keyword,extended,,Tool,Software type.
8.6.1,true,threat,threat.tactic.id,keyword,extended,array,TA0002,Threat tactic id.
8.6.1,true,threat,threat.tactic.name,keyword,extended,array,Execution,Threat tactic.
8.6.1,true,threat,threat.tactic.reference,keyword,extended,array,https://attack.mitre.org/tactics/TA0002/,Threat tactic URL reference.
8.6.1,true,threat,threat.technique.id,keyword,extended,array,T1059,Threat technique id.
8.6.1,true,threat,threat.technique.name,keyword,extended,array,Command and Scripting Interpreter,Threat technique name.
8.6.1,true,threat,threat.technique.name.text,match_only_text,extended,,Command and Scripting Interpreter,Threat technique name.
8.6.1,true,threat,threat.technique.reference,keyword,extended,array,https://attack.mitre.org/techniques/T1059/,Threat technique URL reference.
8.6.1,true,threat,threat.technique.subtechnique.id,keyword,extended,array,T1059.001,Threat subtechnique id.
8.6.1,true,threat,threat.technique.subtechnique.name,keyword,extended,array,PowerShell,Threat subtechnique name.
8.6.1,true,threat,threat.technique.subtechnique.name.text,match_only_text,extended,,PowerShell,Threat subtechnique name.
8.6.1,true,threat,threat.technique.subtechnique.reference,keyword,extended,array,https://attack.mitre.org/techniques/T1059/001/,Threat subtechnique URL reference.
8.6.1,true,tls,tls.cipher,keyword,extended,,TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256,String indicating the cipher used during the current connection.
8.6.1,true,tls,tls.client.certificate,keyword,extended,,MII...,PEM-encoded stand-alone certificate offered by the client.
8.6.1,true,tls,tls.client.certificate_chain,keyword,extended,array,"[""MII..."", ""MII...""]",Array of PEM-encoded certificates that make up the certificate chain offered by the client.
8.6.1,true,tls,tls.client.hash.md5,keyword,extended,,0F76C7F2C55BFD7D8E8B8F4BFBF0C9EC,Certificate fingerprint using the MD5 digest of DER-encoded version of certificate offered by the client.
8.6.1,true,tls,tls.client.hash.sha1,keyword,extended,,9E393D93138888D288266C2D915214D1D1CCEB2A,Certificate fingerprint using the SHA1 digest of DER-encoded version of certificate offered by the client.
8.6.1,true,tls,tls.client.hash.sha256,keyword,extended,,0687F666A054EF17A08E2F2162EAB4CBC0D265E1D7875BE74BF3C712CA92DAF0,Certificate fingerprint using the SHA256 digest of DER-encoded version of certificate offered by the client.
8.6.1,true,tls,tls.client.issuer,keyword,extended,,"CN=Example Root CA, OU=Infrastructure Team, DC=example, DC=com",Distinguished name of subject of the issuer of the x.509 certificate presented by the client.
8.6.1,true,tls,tls.client.ja3,keyword,extended,,d4e5b18d6b55c71272893221c96ba240,A hash that identifies clients based on how they perform an SSL/TLS handshake.
8.6.1,true,tls,tls.client.not_after,date,extended,,2021-01-01T00:00:00.000Z,Date/Time indicating when client certificate is no longer considered valid.
8.6.1,true,tls,tls.client.not_before,date,extended,,1970-01-01T00:00:00.000Z,Date/Time indicating when client certificate is first considered valid.
8.6.1,true,tls,tls.client.server_name,keyword,extended,,www.elastic.co,Hostname the client is trying to connect to. Also called the SNI.
8.6.1,true,tls,tls.client.subject,keyword,extended,,"CN=myclient, OU=Documentation Team, DC=example, DC=com",Distinguished name of subject of the x.509 certificate presented by the client.
8.6.1,true,tls,tls.client.supported_ciphers,keyword,extended,array,"[""TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384"", ""TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384"", ""...""]",Array of ciphers offered by the client during the client hello.
8.6.1,true,tls,tls.client.x509.alternative_names,keyword,extended,array,*.elastic.co,List of subject alternative names (SAN).
8.6.1,true,tls,tls.client.x509.issuer.common_name,keyword,extended,array,Example SHA2 High Assurance Server CA,List of common name (CN) of issuing certificate authority.
8.6.1,true,tls,tls.client.x509.issuer.country,keyword,extended,array,US,List of country \(C) codes
8.6.1,true,tls,tls.client.x509.issuer.distinguished_name,keyword,extended,,"C=US, O=Example Inc, OU=www.example.com, CN=Example SHA2 High Assurance Server CA",Distinguished name (DN) of issuing certificate authority.
8.6.1,true,tls,tls.client.x509.issuer.locality,keyword,extended,array,Mountain View,List of locality names (L)
8.6.1,true,tls,tls.client.x509.issuer.organization,keyword,extended,array,Example Inc,List of organizations (O) of issuing certificate authority.
8.6.1,true,tls,tls.client.x509.issuer.organizational_unit,keyword,extended,array,www.example.com,List of organizational units (OU) of issuing certificate authority.
8.6.1,true,tls,tls.client.x509.issuer.state_or_province,keyword,extended,array,California,"List of state or province names (ST, S, or P)"
8.6.1,true,tls,tls.client.x509.not_after,date,extended,,2020-07-16T03:15:39Z,Time at which the certificate is no longer considered valid.
8.6.1,true,tls,tls.client.x509.not_before,date,extended,,2019-08-16T01:40:25Z,Time at which the certificate is first considered valid.
8.6.1,true,tls,tls.client.x509.public_key_algorithm,keyword,extended,,RSA,Algorithm used to generate the public key.
8.6.1,true,tls,tls.client.x509.public_key_curve,keyword,extended,,nistp521,The curve used by the elliptic curve public key algorithm. This is algorithm specific.
8.6.1,false,tls,tls.client.x509.public_key_exponent,long,extended,,65537,Exponent used to derive the public key. This is algorithm specific.
8.6.1,true,tls,tls.client.x509.public_key_size,long,extended,,2048,The size of the public key space in bits.
8.6.1,true,tls,tls.client.x509.serial_number,keyword,extended,,55FBB9C7DEBF09809D12CCAA,Unique serial number issued by the certificate authority.
8.6.1,true,tls,tls.client.x509.signature_algorithm,keyword,extended,,SHA256-RSA,Identifier for certificate signature algorithm.
8.6.1,true,tls,tls.client.x509.subject.common_name,keyword,extended,array,shared.global.example.net,List of common names (CN) of subject.
8.6.1,true,tls,tls.client.x509.subject.country,keyword,extended,array,US,List of country \(C) code
8.6.1,true,tls,tls.client.x509.subject.distinguished_name,keyword,extended,,"C=US, ST=California, L=San Francisco, O=Example, Inc., CN=shared.global.example.net",Distinguished name (DN) of the certificate subject entity.
8.6.1,true,tls,tls.client.x509.subject.locality,keyword,extended,array,San Francisco,List of locality names (L)
8.6.1,true,tls,tls.client.x509.subject.organization,keyword,extended,array,"Example, Inc.",List of organizations (O) of subject.
8.6.1,true,tls,tls.client.x509.subject.organizational_unit,keyword,extended,array,,List of organizational units (OU) of subject.
8.6.1,true,tls,tls.client.x509.subject.state_or_province,keyword,extended,array,California,"List of state or province names (ST, S, or P)"
8.6.1,true,tls,tls.client.x509.version_number,keyword,extended,,3,Version of x509 format.
8.6.1,true,tls,tls.curve,keyword,extended,,secp256r1,"String indicating the curve used for the given cipher, when applicable."
8.6.1,true,tls,tls.established,boolean,extended,,,Boolean flag indicating if the TLS negotiation was successful and transitioned to an encrypted tunnel.
8.6.1,true,tls,tls.next_protocol,keyword,extended,,http/1.1,String indicating the protocol being tunneled.
8.6.1,true,tls,tls.resumed,boolean,extended,,,Boolean flag indicating if this TLS connection was resumed from an existing TLS negotiation.
8.6.1,true,tls,tls.server.certificate,keyword,extended,,MII...,PEM-encoded stand-alone certificate offered by the server.
8.6.1,true,tls,tls.server.certificate_chain,keyword,extended,array,"[""MII..."", ""MII...""]",Array of PEM-encoded certificates that make up the certificate chain offered by the server.
8.6.1,true,tls,tls.server.hash.md5,keyword,extended,,0F76C7F2C55BFD7D8E8B8F4BFBF0C9EC,Certificate fingerprint using the MD5 digest of DER-encoded version of certificate offered by the server.
8.6.1,true,tls,tls.server.hash.sha1,keyword,extended,,9E393D93138888D288266C2D915214D1D1CCEB2A,Certificate fingerprint using the SHA1 digest of DER-encoded version of certificate offered by the server.
8.6.1,true,tls,tls.server.hash.sha256,keyword,extended,,0687F666A054EF17A08E2F2162EAB4CBC0D265E1D7875BE74BF3C712CA92DAF0,Certificate fingerprint using the SHA256 digest of DER-encoded version of certificate offered by the server.
8.6.1,true,tls,tls.server.issuer,keyword,extended,,"CN=Example Root CA, OU=Infrastructure Team, DC=example, DC=com",Subject of the issuer of the x.509 certificate presented by the server.
8.6.1,true,tls,tls.server.ja3s,keyword,extended,,394441ab65754e2207b1e1b457b3641d,A hash that identifies servers based on how they perform an SSL/TLS handshake.
8.6.1,true,tls,tls.server.not_after,date,extended,,2021-01-01T00:00:00.000Z,Timestamp indicating when server certificate is no longer considered valid.
8.6.1,true,tls,tls.server.not_before,date,extended,,1970-01-01T00:00:00.000Z,Timestamp indicating when server certificate is first considered valid.
8.6.1,true,tls,tls.server.subject,keyword,extended,,"CN=www.example.com, OU=Infrastructure Team, DC=example, DC=com",Subject of the x.509 certificate presented by the server.
8.6.1,true,tls,tls.server.x509.alternative_names,keyword,extended,array,*.elastic.co,List of subject alternative names (SAN).
8.6.1,true,tls,tls.server.x509.issuer.common_name,keyword,extended,array,Example SHA2 High Assurance Server CA,List of common name (CN) of issuing certificate authority.
8.6.1,true,tls,tls.server.x509.issuer.country,keyword,extended,array,US,List of country \(C) codes
8.6.1,true,tls,tls.server.x509.issuer.distinguished_name,keyword,extended,,"C=US, O=Example Inc, OU=www.example.com, CN=Example SHA2 High Assurance Server CA",Distinguished name (DN) of issuing certificate authority.
8.6.1,true,tls,tls.server.x509.issuer.locality,keyword,extended,array,Mountain View,List of locality names (L)
8.6.1,true,tls,tls.server.x509.issuer.organization,keyword,extended,array,Example Inc,List of organizations (O) of issuing certificate authority.
8.6.1,true,tls,tls.server.x509.issuer.organizational_unit,keyword,extended,array,www.example.com,List of organizational units (OU) of issuing certificate authority.
8.6.1,true,tls,tls.server.x509.issuer.state_or_province,keyword,extended,array,California,"List of state or province names (ST, S, or P)"
8.6.1,true,tls,tls.server.x509.not_after,date,extended,,2020-07-16T03:15:39Z,Time at which the certificate is no longer considered valid.
8.6.1,true,tls,tls.server.x509.not_before,date,extended,,2019-08-16T01:40:25Z,Time at which the certificate is first considered valid.
8.6.1,true,tls,tls.server.x509.public_key_algorithm,keyword,extended,,RSA,Algorithm used to generate the public key.
8.6.1,true,tls,tls.server.x509.public_key_curve,keyword,extended,,nistp521,The curve used by the elliptic curve public key algorithm. This is algorithm specific.
8.6.1,false,tls,tls.server.x509.public_key_exponent,long,extended,,65537,Exponent used to derive the public key. This is algorithm specific.
8.6.1,true,tls,tls.server.x509.public_key_size,long,extended,,2048,The size of the public key space in bits.
8.6.1,true,tls,tls.server.x509.serial_number,keyword,extended,,55FBB9C7DEBF09809D12CCAA,Unique serial number issued by the certificate authority.
8.6.1,true,tls,tls.server.x509.signature_algorithm,keyword,extended,,SHA256-RSA,Identifier for certificate signature algorithm.
8.6.1,true,tls,tls.server.x509.subject.common_name,keyword,extended,array,shared.global.example.net,List of common names (CN) of subject.
8.6.1,true,tls,tls.server.x509.subject.country,keyword,extended,array,US,List of country \(C) code
8.6.1,true,tls,tls.server.x509.subject.distinguished_name,keyword,extended,,"C=US, ST=California, L=San Francisco, O=Example, Inc., CN=shared.global.example.net",Distinguished name (DN) of the certificate subject entity.
8.6.1,true,tls,tls.server.x509.subject.locality,keyword,extended,array,San Francisco,List of locality names (L)
8.6.1,true,tls,tls.server.x509.subject.organization,keyword,extended,array,"Example, Inc.",List of organizations (O) of subject.
8.6.1,true,tls,tls.server.x509.subject.organizational_unit,keyword,extended,array,,List of organizational units (OU) of subject.
8.6.1,true,tls,tls.server.x509.subject.state_or_province,keyword,extended,array,California,"List of state or province names (ST, S, or P)"
8.6.1,true,tls,tls.server.x509.version_number,keyword,extended,,3,Version of x509 format.
8.6.1,true,tls,tls.version,keyword,extended,,1.2,Numeric part of the version parsed from the original string.
8.6.1,true,tls,tls.version_protocol,keyword,extended,,tls,Normalized lowercase protocol name parsed from original string.
8.6.1,true,trace,trace.id,keyword,extended,,4bf92f3577b34da6a3ce929d0e0e4736,Unique identifier of the trace.
8.6.1,true,transaction,transaction.id,keyword,extended,,00f067aa0ba902b7,Unique identifier of the transaction within the scope of its trace.
8.6.1,true,url,url.domain,keyword,extended,,www.elastic.co,Domain of the url.
8.6.1,true,url,url.extension,keyword,extended,,png,"File extension from the request url, excluding the leading dot."
8.6.1,true,url,url.fragment,keyword,extended,,,Portion of the url after the `#`.
8.6.1,true,url,url.full,wildcard,extended,,https://www.elastic.co:443/search?q=elasticsearch#top,Full unparsed URL.
8.6.1,true,url,url.full.text,match_only_text,extended,,https://www.elastic.co:443/search?q=elasticsearch#top,Full unparsed URL.
8.6.1,true,url,url.original,wildcard,extended,,https://www.elastic.co:443/search?q=elasticsearch#top or /search?q=elasticsearch,Unmodified original url as seen in the event source.
8.6.1,true,url,url.original.text,match_only_text,extended,,https://www.elastic.co:443/search?q=elasticsearch#top or /search?q=elasticsearch,Unmodified original url as seen in the event source.
8.6.1,true,url,url.password,keyword,extended,,,Password of the request.
8.6.1,true,url,url.path,wildcard,extended,,,"Path of the request, such as ""/search""."
8.6.1,true,url,url.port,long,extended,,443,"Port of the request, such as 443."
8.6.1,true,url,url.query,keyword,extended,,,Query string of the request.
8.6.1,true,url,url.registered_domain,keyword,extended,,example.com,"The highest registered url domain, stripped of the subdomain."
8.6.1,true,url,url.scheme,keyword,extended,,https,Scheme of the url.
8.6.1,true,url,url.subdomain,keyword,extended,,east,The subdomain of the domain.
8.6.1,true,url,url.top_level_domain,keyword,extended,,co.uk,"The effective top level domain (com, org, net, co.uk)."
8.6.1,true,url,url.username,keyword,extended,,,Username of the request.
8.6.1,true,user,user.changes.domain,keyword,extended,,,Name of the directory the user is a member of.
8.6.1,true,user,user.changes.email,keyword,extended,,,User email address.
8.6.1,true,user,user.changes.full_name,keyword,extended,,Albert Einstein,"User's full name, if available."
8.6.1,true,user,user.changes.full_name.text,match_only_text,extended,,Albert Einstein,"User's full name, if available."
8.6.1,true,user,user.changes.group.domain,keyword,extended,,,Name of the directory the group is a member of.
8.6.1,true,user,user.changes.group.id,keyword,extended,,,Unique identifier for the group on the system/platform.
8.6.1,true,user,user.changes.group.name,keyword,extended,,,Name of the group.
8.6.1,true,user,user.changes.hash,keyword,extended,,,Unique user hash to correlate information for a user in anonymized form.
8.6.1,true,user,user.changes.id,keyword,core,,S-1-5-21-202424912787-2692429404-2351956786-1000,Unique identifier of the user.
8.6.1,true,user,user.changes.name,keyword,core,,a.einstein,Short name or login of the user.
8.6.1,true,user,user.changes.name.text,match_only_text,core,,a.einstein,Short name or login of the user.
8.6.1,true,user,user.changes.roles,keyword,extended,array,"[""kibana_admin"", ""reporting_user""]",Array of user roles at the time of the event.
8.6.1,true,user,user.domain,keyword,extended,,,Name of the directory the user is a member of.
8.6.1,true,user,user.effective.domain,keyword,extended,,,Name of the directory the user is a member of.
8.6.1,true,user,user.effective.email,keyword,extended,,,User email address.
8.6.1,true,user,user.effective.full_name,keyword,extended,,Albert Einstein,"User's full name, if available."
8.6.1,true,user,user.effective.full_name.text,match_only_text,extended,,Albert Einstein,"User's full name, if available."
8.6.1,true,user,user.effective.group.domain,keyword,extended,,,Name of the directory the group is a member of.
8.6.1,true,user,user.effective.group.id,keyword,extended,,,Unique identifier for the group on the system/platform.
8.6.1,true,user,user.effective.group.name,keyword,extended,,,Name of the group.
8.6.1,true,user,user.effective.hash,keyword,extended,,,Unique user hash to correlate information for a user in anonymized form.
8.6.1,true,user,user.effective.id,keyword,core,,S-1-5-21-202424912787-2692429404-2351956786-1000,Unique identifier of the user.
8.6.1,true,user,user.effective.name,keyword,core,,a.einstein,Short name or login of the user.
8.6.1,true,user,user.effective.name.text,match_only_text,core,,a.einstein,Short name or login of the user.
8.6.1,true,user,user.effective.roles,keyword,extended,array,"[""kibana_admin"", ""reporting_user""]",Array of user roles at the time of the event.
8.6.1,true,user,user.email,keyword,extended,,,User email address.
8.6.1,true,user,user.full_name,keyword,extended,,Albert Einstein,"User's full name, if available."
8.6.1,true,user,user.full_name.text,match_only_text,extended,,Albert Einstein,"User's full name, if available."
8.6.1,true,user,user.group.domain,keyword,extended,,,Name of the directory the group is a member of.
8.6.1,true,user,user.group.id,keyword,extended,,,Unique identifier for the group on the system/platform.
8.6.1,true,user,user.group.name,keyword,extended,,,Name of the group.
8.6.1,true,user,user.hash,keyword,extended,,,Unique user hash to correlate information for a user in anonymized form.
8.6.1,true,user,user.id,keyword,core,,S-1-5-21-202424912787-2692429404-2351956786-1000,Unique identifier of the user.
8.6.1,true,user,user.name,keyword,core,,a.einstein,Short name or login of the user.
8.6.1,true,user,user.name.text,match_only_text,core,,a.einstein,Short name or login of the user.
8.6.1,true,user,user.risk.calculated_level,keyword,extended,,High,A risk classification level calculated by an internal system as part of entity analytics and entity risk scoring.
8.6.1,true,user,user.risk.calculated_score,float,extended,,880.73,A risk classification score calculated by an internal system as part of entity analytics and entity risk scoring.
8.6.1,true,user,user.risk.calculated_score_norm,float,extended,,88.73,A normalized risk score calculated by an internal system.
8.6.1,true,user,user.risk.static_level,keyword,extended,,High,"A risk classification level obtained from outside the system, such as from some external Threat Intelligence Platform."
8.6.1,true,user,user.risk.static_score,float,extended,,830.0,"A risk classification score obtained from outside the system, such as from some external Threat Intelligence Platform."
8.6.1,true,user,user.risk.static_score_norm,float,extended,,83.0,A normalized risk score calculated by an external system.
8.6.1,true,user,user.roles,keyword,extended,array,"[""kibana_admin"", ""reporting_user""]",Array of user roles at the time of the event.
8.6.1,true,user,user.target.domain,keyword,extended,,,Name of the directory the user is a member of.
8.6.1,true,user,user.target.email,keyword,extended,,,User email address.
8.6.1,true,user,user.target.full_name,keyword,extended,,Albert Einstein,"User's full name, if available."
8.6.1,true,user,user.target.full_name.text,match_only_text,extended,,Albert Einstein,"User's full name, if available."
8.6.1,true,user,user.target.group.domain,keyword,extended,,,Name of the directory the group is a member of.
8.6.1,true,user,user.target.group.id,keyword,extended,,,Unique identifier for the group on the system/platform.
8.6.1,true,user,user.target.group.name,keyword,extended,,,Name of the group.
8.6.1,true,user,user.target.hash,keyword,extended,,,Unique user hash to correlate information for a user in anonymized form.
8.6.1,true,user,user.target.id,keyword,core,,S-1-5-21-202424912787-2692429404-2351956786-1000,Unique identifier of the user.
8.6.1,true,user,user.target.name,keyword,core,,a.einstein,Short name or login of the user.
8.6.1,true,user,user.target.name.text,match_only_text,core,,a.einstein,Short name or login of the user.
8.6.1,true,user,user.target.roles,keyword,extended,array,"[""kibana_admin"", ""reporting_user""]",Array of user roles at the time of the event.
8.6.1,true,user_agent,user_agent.device.name,keyword,extended,,iPhone,Name of the device.
8.6.1,true,user_agent,user_agent.name,keyword,extended,,Safari,Name of the user agent.
8.6.1,true,user_agent,user_agent.original,keyword,extended,,"Mozilla/5.0 (iPhone; CPU iPhone OS 12_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/12.0 Mobile/15E148 Safari/604.1",Unparsed user_agent string.
8.6.1,true,user_agent,user_agent.original.text,match_only_text,extended,,"Mozilla/5.0 (iPhone; CPU iPhone OS 12_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/12.0 Mobile/15E148 Safari/604.1",Unparsed user_agent string.
8.6.1,true,user_agent,user_agent.os.family,keyword,extended,,debian,"OS family (such as redhat, debian, freebsd, windows)."
8.6.1,true,user_agent,user_agent.os.full,keyword,extended,,Mac OS Mojave,"Operating system name, including the version or code name."
8.6.1,true,user_agent,user_agent.os.full.text,match_only_text,extended,,Mac OS Mojave,"Operating system name, including the version or code name."
8.6.1,true,user_agent,user_agent.os.kernel,keyword,extended,,4.4.0-112-generic,Operating system kernel version as a raw string.
8.6.1,true,user_agent,user_agent.os.name,keyword,extended,,Mac OS X,"Operating system name, without the version."
8.6.1,true,user_agent,user_agent.os.name.text,match_only_text,extended,,Mac OS X,"Operating system name, without the version."
8.6.1,true,user_agent,user_agent.os.platform,keyword,extended,,darwin,"Operating system platform (such centos, ubuntu, windows)."
8.6.1,true,user_agent,user_agent.os.type,keyword,extended,,macos,"Which commercial OS family (one of: linux, macos, unix, windows, ios or android)."
8.6.1,true,user_agent,user_agent.os.version,keyword,extended,,10.14.1,Operating system version as a raw string.
8.6.1,true,user_agent,user_agent.version,keyword,extended,,12.0,Version of the user agent.
8.6.1,true,vulnerability,vulnerability.category,keyword,extended,array,"[""Firewall""]",Category of a vulnerability.
8.6.1,true,vulnerability,vulnerability.classification,keyword,extended,,CVSS,Classification of the vulnerability.
8.6.1,true,vulnerability,vulnerability.description,keyword,extended,,"In macOS before 2.12.6, there is a vulnerability in the RPC...",Description of the vulnerability.
8.6.1,true,vulnerability,vulnerability.description.text,match_only_text,extended,,"In macOS before 2.12.6, there is a vulnerability in the RPC...",Description of the vulnerability.
8.6.1,true,vulnerability,vulnerability.enumeration,keyword,extended,,CVE,Identifier of the vulnerability.
8.6.1,true,vulnerability,vulnerability.id,keyword,extended,,CVE-2019-00001,ID of the vulnerability.
8.6.1,true,vulnerability,vulnerability.reference,keyword,extended,,https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2019-6111,Reference of the vulnerability.
8.6.1,true,vulnerability,vulnerability.report_id,keyword,extended,,20191018.0001,Scan identification number.
8.6.1,true,vulnerability,vulnerability.scanner.vendor,keyword,extended,,Tenable,Name of the scanner vendor.
8.6.1,true,vulnerability,vulnerability.score.base,float,extended,,5.5,Vulnerability Base score.
8.6.1,true,vulnerability,vulnerability.score.environmental,float,extended,,5.5,Vulnerability Environmental score.
8.6.1,true,vulnerability,vulnerability.score.temporal,float,extended,,,Vulnerability Temporal score.
8.6.1,true,vulnerability,vulnerability.score.version,keyword,extended,,2.0,CVSS version.
8.6.1,true,vulnerability,vulnerability.severity,keyword,extended,,Critical,Severity of the vulnerability.
